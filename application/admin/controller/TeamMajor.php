...
class TeamMajor extends Controller
{
    ...
    {
    	if ($this->request->param("subject_id")) {
            $map['subject_id'] = ["=",$this->request->param("subject_id")];
        }
        $this->view->assign("subject_id",$this->request->param("subject_id"));
    }  
