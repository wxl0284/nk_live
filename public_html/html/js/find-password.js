...
X.sub("init", function() {
    ...
    $(".sendCode1").on("click", function() {
        ...
        if (regMethod == 1) {
            ...
            isSend = false;
            sendSms("/sms/api/password/send", phone, $(".sendCode1"));
        } else {
            email = f.email.value;
            if (!email.length) {
                if (LANG == "EN") {
            ...
            isSend = false;
            sendSms("/email/api/password/code/send", email, $(".sendCode1"));
        }
    });
    ...
    $("#submitBtn").click(function() {
        ...
        // }
        onSubmit()
        X.post("/api/nologin/user/sms/check", item, onSubmit);
    });
    ...
    $("#submitBtn2").click(function() {
        ...
        onSubmit2()
        X.post("/api/nologin/user/password/change", item, onSubmit2);
    });
