...
X.sub("init", function() {
    ...
    function onChoicetype() {
        ...
        res += '<li class="nav_item"><a href="index.html">' + (LANG == "EN" ? EN.public.index : "首页") + '</a></li>';
        res += '<li class="nav_item" id="subsLink">';
        res += '<a href="subject_sort.html">' + (LANG == "EN" ? EN.public.subject : "学科分类") + '</a>';
        res += '<ul class="subjects-box"></ul>';
        res += '</li>';
        res += '<li class="nav_item"><a href="intro.html">' + (LANG == "EN" ? EN.public.projectInt : "项目介绍") + '</a></li>';
        res += '<li class="nav_item"><a href="about.html">' + (LANG == "EN" ? EN.public.aboutUs : "关于我们") + '</a></li>';
        $("#menu").html(res);
