...
X.sub("init", function() {
    ...
    function onGetContent(respText) {
        ...
        if(item.like_s == 0){
            ...
            res += '<button type="button" class="btn btn-white btn-opacity" id="likeBtn" Style="background-image: url(/static/index/pic/clickgood2.png);"><i class="iconfont"></i></button>';
        }
        ...
        function gotoConfirm() {
            ...
            var item = {};
                item.title = "提示";
                item.msg = '<p class="goLink-tip">是否要做实验。</p><p class="goLink-link" ><a href="javascript:;" id="confirmSubject">确认</a></p>';
                item.okText = "取消";
            item.noCancel = true;
