...
X.sub("init", function() {
    ...
    var vt = 0;
    var enable = true;
    var default_okText = "确认";
    var default_cancel = "取消";
    var default_title = "提示";

    overlay.style.visibility = 'hidden';
    overlay.innerHTML = '<div id="dialog_bg"></div><div id="dialog_panel"><div id="dialog_panel_bg"></div><div id="dialog_title">' + default_title + '</div><div id="dialog_content"> </div><div id="dialog_control"><a href="javascript:void(0)" id="dialog_close" class="button" style="display:none;">' + default_cancel + '</a><a href="javascript:void(0)" id="dialog_ok" class="button">' + default_okText + '</a></div></div>';
    ...
    function onDisplay(evt, obj) {
        ...
        if ('string' === typeof obj) {
            ...
            X('dialog_title').innerHTML = obj.title || default_title;
        ...
        if (obj.type == 1) {
            ...
            X('dialog_bg').style.display = 'none';
            X('dialog_title').style.display = 'none';
            overlay.style.background = 'none';
            XPE.className(e).add('dialog_modal');
            if (obj.loading) {
                XPE.className(e).add('loading_modal');
            } else {
                XPE.className(e).remove('loading_modal');
            ...
            X('dialog_title').style.display = 'none';
            overlay.style.background = 'none';
            XPE.className(e).add('dialog_progress');
            XPE.className(e).remove('loading_modal');
        } else {
            X('dialog_control').style.display = '';
            // X('dialog_title').style.display = '';
            X('dialog_bg').style.display = '';
            //overlay.style.background = 'rgba(0,0,0,0.6)';
            if (obj.doNotShowTitle) {
                X('dialog_title').style.display = 'none';
            } else {
                X('dialog_title').style.display = 'block';
            }
        }
    ...
    X.sub("resizeDialog", resizeDialog);
