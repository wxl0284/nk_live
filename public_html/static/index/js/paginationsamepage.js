X.sub("pagination", function(evt, resp) {
    ...
    if (currentPage > 1) {
        ...
        sb.append((((currentPage - 2) * limit)) + "});return false;");
        sb.append()
            .append('" rel="prev" >« 上一页</a></li>');
    }
    if (firstPage > 2) {
    ...
    for (var i = firstPage; i < lastPage + 1; ++i) {
        if (i === currentPage) {
            ...
            sb.append((((i - 1) * limit)) + "});return false;");
            sb.append('" rel="next">');
    ...
    if (lastPage < totalPages) {
        sb.append('<li ><a href="/#" onclick="X.pub(\'' + (resp.evt || "gotoPage") + '\',{start:');
        sb.append((((totalPages - 1) * limit)) + "});return false;");
        sb.append('" rel="next">');
    ...
    if (currentPage * limit < total) {
        ...
        sb.append('<a href="/#" onclick="X.pub(\'' + (resp.evt || "gotoPage") + '\',{start:');
        sb.append(((currentPage * limit)) + "});return false;");
        sb.append()
            .append('" rel="prev" >下一页 »</a></li>');
    }
