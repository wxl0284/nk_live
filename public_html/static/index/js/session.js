...
X.sub("init", function() {
    ...
    function noLogin() {
        X.pub("userNotLogin");
        var res = '';
        //res += '<a href="/index/login/index" class="to-login">会员登录</a><span class="line">|</span><a href="/index/register/index" class="to-register">会员注册</a>';
        res += '<a href="/index/login/index" class="to-login">会员登录</a>';
        $("#user-info").html(res);
    }
