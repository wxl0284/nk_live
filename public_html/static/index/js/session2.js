...
X.sub("init", function() {
    ...
    function checkSession() {
        if (X.cookie.get('xsid')) {
            X.get("/index/user/session", onGetSession);
        } else {
            noLogin();
        }
    }
    ...
    function noLogin() {
        X.pub("userNotLogin");
        var res = '';
        //res += '<a href="/index/login/index" class="to-login">登录</a><span class="line">|</span><a href="/index/register/index" class="to-register">注册</a>';
        res += '<a href="/index/login/index" class="to-login">登录</a>';
